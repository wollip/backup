   ...
   /* private Image ball;
    ...
    private void doDrawing(Graphics g) {
        ...
        if (inGame) {
            ...
            g.drawString(spoints, 10 ,B_HEIGHT + 50);
            
            g.drawLine(0, B_HEIGHT, B_WIDTH, B_HEIGHT);
	...
	private void gameOver(Graphics g) {
        ...
        g.setColor(Color.white);
        g.setFont(small);
        g.drawString(msg, (B_WIDTH - metr.stringWidth(msg)) / 2, W_HEIGHT / 2);
        g.drawString(spoints,(B_WIDTH - metr.stringWidth(spoints)) / 2 , W_HEIGHT / 2 +50);
    }
